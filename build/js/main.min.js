...
const objectSlider=new Swiper(".object__slider",{speed:500,loop:!0,effect:"fade",slidesPerView:1,pagination:{el:".swiper-pagination",clickable:!0},navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}});
